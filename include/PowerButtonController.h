...
class PowerButtonController {
   private:
    ...
    int64_t minShortPressTime = 1L;     // normally at 50 // used to avoid double clicks due to a cheap button
    ...
    void shortPress();
    static void interruptHandler(int gpio, int level, uint32_t tick, void* controller);

   public:
    void edgeChanging(bool buttonLevelIsHigh);
